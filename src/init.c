...
void init_game(game_t *game)
{
    ...
    game->obj[2] = create_object((sfIntRect) {0, 0, 512, 512},"assets/Button_settings.png", 1750, 30);
    ...
    game->obj[5] = create_object((sfIntRect) {0, 0, 512, 512},"assets/Button_settings_crunch.png", 1750, 30);
    sfSprite_setScale(game->obj[5]->sprite, scale2);
    game->obj[6] = create_object((sfIntRect) {0, 0, 512, 512},"assets/Button_quit_crunch.png", 1500, 400);
