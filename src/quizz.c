...
void process_game(game_t *game)
{
    ...
    game->obj[2] = create_object((sfIntRect) {0, 0, 512, 512},"assets/Button_settings.png", 250, 300);
    sfSprite_setScale(game->obj[2]->sprite, scale);
    game->obj[3] = create_object((sfIntRect) {0, 0, 512, 512},"assets/Button_quit.png", 250, 600);
